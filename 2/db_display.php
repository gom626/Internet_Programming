...
if(($result->num_rows) > "0") {
	...
	echo "Order Number"."&nbsp&nbsp&nbsp"."ID Number"."&nbsp&nbsp&nbsp"."name"."&nbsp&nbsp&nbsp"."E-mail"."&nbsp&nbsp&nbsp&nbsp"."Phone Number"."&nbsp&nbsp&nbsp"."Topping"."&nbsp&nbsp&nbsp"."Pay_Method"."&nbsp&nbsp&nbsp"."call-first","&nbsp&nbsp&nbsp"."reg_date"."<br>";
    while($row = $result->fetch_assoc()) {
        echo $row["Order_Number"]."&nbsp&nbsp&nbsp".$row["name"]."&nbsp&nbsp&nbsp&nbsp".$row["e_mail"]."&nbsp&nbsp&nbsp".$row["Phone_Number"]."&nbsp&nbsp&nbsp".$row["Topping"]."&nbsp&nbsp&nbsp".$row["pay_Method"]."&nbsp&nbsp&nbsp".$row["call_first"]."&nbsp&nbsp&nbsp".$row["reg_date"]."<br>";
    }
} else {
    echo "0 results";
}
